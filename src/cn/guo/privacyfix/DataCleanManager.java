...
public class DataCleanManager {
	/**
	 * 清除指定应用缓存/data/data/com.xxx.xxx
	 */
	public static void cleanAll(String str) {
		deleteFolderFile("/data/data/" + str + "/",true);
		// writeDatabaseFile(new File("/data/data/"+ str
		// +"/hah.txt"),"1111111111");
	}
	...
	public static void writeDatabaseFile(File fileName, String fileContext) {
		try {
